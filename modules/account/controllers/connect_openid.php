 ...
 */
class Connect_openid extends Controller {

	/**
	 * Constructor
	 */
	function Connect_openid()
	{
		parent::Controller();
		
		// Load the necessary stuff...
		$this->load->config('account/account');
		$this->load->plugin('openid');
...
/* Location: ./system/application/modules/account/controllers/connect_openid.php */