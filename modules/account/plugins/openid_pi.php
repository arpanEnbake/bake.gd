...
set_include_path(APPPATH.'modules/account/plugins/php-openid-php5.3/'.PATH_SEPARATOR.get_include_path());
...
/* End of file openid_pi.php */
/* Location: ./system/application/modules/account/plugins/openid_pi.php */