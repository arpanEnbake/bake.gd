...
echo $javascript->link('rgraph/RGraph.common.core.js"');
echo $javascript->link('rgraph/RGraph.common.annotate.js"');
echo $javascript->link('rgraph/RGraph.common.context.js"');
echo $javascript->link('rgraph/RGraph.common.tooltips.js"');
echo $javascript->link('rgraph/RGraph.common.resizing.js"');
echo $javascript->link('rgraph/RGraph.bar.js"');
?>
<canvas id="myCanvas" width="600" height="300">[No canvas support]</canvas>
<script>
$.ajax({
    type: "post",
    url: "/graph/graphs/barchartdata",    
    dataType: 'json',
